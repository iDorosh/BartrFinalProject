...
class CustomIOS8AlertView: UIView {
    ...
    private func setObservers() {
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CustomIOS8AlertView.deviceOrientationDidChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CustomIOS8AlertView.keyboardWillShow(_:)), name:UIKeyboardWillShowNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CustomIOS8AlertView.keyboardWillHide(_:)), name:UIKeyboardWillHideNotification, object: nil)
    }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        for buttonIndex in 0...(buttonTitles!.count - 1) {
            ...
            button.addTarget(self, action: #selector(CustomIOS8AlertView.buttonTouchUpInside(_:)), forControlEvents: UIControlEvents.TouchUpInside)
