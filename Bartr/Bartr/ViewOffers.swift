...
//Actions
    @IBAction func deleteOfferAction(sender: UIButton) { deleteOfferAlert() }
    @IBAction func backClicked(sender: UIButton) { back() }
    @IBAction func newMessage(sender: UIButton) { performSegueWithIdentifier("NewMessage", sender: self) }
    @IBAction func acceptOffer(sender: UIButton) { self.sendAccepted() }
    @IBAction func declineOffer(sender: UIButton) { self.backToOffer() }
    @IBAction func cancelOffer(sender: UIButton) { cancelOffer() }
