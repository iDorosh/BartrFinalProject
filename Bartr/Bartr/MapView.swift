...
//Outlets
    ...
    override func viewWillAppear(animated: Bool) { loadUI() }
...
//Functions
    ...
    func loadUI(){
        ...
        loadOverlayForRegionWithLatitude(lat + Double.random(0.001, 0.01), andLongitude: lon + Double.random(0.001, 0.01))
    }
